...
export const useGolbalContext = () => useContext(GlobalContext)
...
const GlobalProvider = ({ children }) => {
    ...
    useEffect(() => {
        ...
        const tPrice = cartItem.reduce((preve, cur) => {
            const priceAfterDiscount = priceWithDiscount(cur?.productId?.price, cur?.productId?.discount)
            return preve + (priceAfterDiscount * cur.quantity)
        }, 0)
        setTotalPrice(tPrice)

        const noDiscountPrice = cartItem.reduce((preve, cur) => {
