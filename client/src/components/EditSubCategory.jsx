...
const EditSubCategory = ({ close , data , fetchData }) => {
    ...
    return (
        <section className='fixed top-0 right-0 left-0 bottom-0 z-50 bg-neutral-800 bg-opacity-70 flex items-center justify-center p-4'>
                    ...
                    <div className='grid gap-1'>
                        ...
                        <div className='flex flex-col lg:flex-row items-center gap-3'>
                            ...
                            <label htmlFor='uploadSubCategoryImage'>
                                <div className='px-4 py-1 border cursor-pointer border-primary-100 text-primary-200 hover:bg-primary-200 hover:text-neutral-900 rounded'>
                                    Upload Image
                                </div>
                                <input
                                    type="file"
                            ...
                            <div className='flex flex-wrap gap-2'>
                                {
                                    subCategoryData.category.map((cat, index) => {
                                        return (
                                            <div key={cat._id + "SelectedValue"} className='bg-white shadow-md px-1 m-1 flex items-center gap-2'>{cat.name}
