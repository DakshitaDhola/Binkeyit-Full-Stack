...
const EditProductAdmin = ({ close , data : propsData , fetchProductData }) => {
    ...
    return (
        <section className='fixed top-0 bottom-0 right-0 left-0 bg-black z-50 bg-opacity-50 p-4'>
            <div className='bg-white w-full p-4 max-w-2xl mx-auto rounded overflow-y-auto max-h-[95vh] h-full'>
                <section>
