...
const EditCategory = ({ close, fetchData, data : CategoryData }) => {
    ...
    return (
        <section className='fixed top-0 bottom-0 right-0 left-0 p-4
                    ...
                    <div className='grid gap-1'>
                        ...
                        <div className='flex gap-2 flex-col lg:flex-row items-center'>
                            ...
                            <label htmlFor="uploadCategoryImage">
                                <div className={`
                                            ${!data.name ? "bg-gray-400" : "border-primary-200 hover:bg-primary-100"}
                                            px-4 py-2 rounded border font-medium cursor-pointer
                                        `}>
                                            {
